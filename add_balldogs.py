def modify_item_attributes():
    ...
    for i in item_list:
        if item_list[i]["collection_name"] == "Balldog Collection":
            if item_list[i]["item_type"] == "unknown":
                print("new balldog")
                ...
                item_list[i]["in-game-attributes"]["2"] = {}
                item_list[i]["in-game-attributes"]["2"]["type"] = choice(attr_list)
                item_list[i]["in-game-attributes"]["2"]["factor"] = "random"
                item_list[i]["in-game-attributes"]["2"]["value"] = 5
                item_list[i]["in-game-attributes"]["2"]["buff_requirement"] = "feed"
                item_list[i]["in-game-attributes"]["2"]["feed"] = "Dog Food"
                item_list[i]["in-game-attributes"]["2"]["buff_duration"] = 30
        if item_list[i]["collection_name"] == "Anti Dogg Collection":
            if item_list[i]["item_type"] == "unknown":
                print("new anti balldog")
                item_list[i]["item_type"] = "pet"
                attr_list = ["buff_str", "buff_dex", "buff_con", "buff_int", "buff_wis", "buff_cha", "buff_luc"]
                atk_list = ["buff_pierce", "buff_bash", "buff_slash"]
                if item_list[i]["on-chain-attributes"].get("10") != None:
                    ...
                    if item_list[i]["on-chain-attributes"]["10"]["value"] == "Thor":
                        ...
                        item_list[i]["in-game-attributes"]["1"]["feed"] = "Dog Food"
                        item_list[i]["in-game-attributes"]["1"]["buff_duration"] = 30
                    if item_list[i]["on-chain-attributes"]["10"]["value"] == "Antidogg":
                        item_list[i]["in-game-attributes"]["0"] = {}
                        item_list[i]["in-game-attributes"]["0"]["type"] = choice(atk_list)
                        item_list[i]["in-game-attributes"]["0"]["factor"] = "random"
                        item_list[i]["in-game-attributes"]["0"]["value"] = 2
                        item_list[i]["in-game-attributes"]["0"]["buff_requirement"] = "feed"
                        item_list[i]["in-game-attributes"]["0"]["feed"] = "Dog Food"
