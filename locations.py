...
def locate(location):
    ...
    if here.location == 'Tavern':
        ...
        here.monsters = ['Cockroach']*7 + ['Mouse']*2 + ['Drunk Man']*1
    ...
    if here.location == 'Marketplace':
        ...
        here.monsters = ['Cockroach']*5 + ['Mouse']*2 + ['Thief']*2 + ['Scum']*1
    ...
    if here.location == 'East Kingdom Street':
        ...
        here.monsters = ['Cockroach']*4 + ['Mouse']*4 + ['Thief']*2
    ...
    if here.location == 'Gate of Viridis':
        ...
        here.monsters = ['Cockroach']*5 + ['Mouse']*4 + ['Gate Guard']
    ...
    if here.location == 'A Lake in Slime Forest':
        ...
        here.monsters = ['Forest Slime']*5 + ['Aquatic Slime']*5
