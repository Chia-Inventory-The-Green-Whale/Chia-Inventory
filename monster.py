...
def encounter(monster):
    ...
    if monster.name == "Murloc Grunt":
        ...
        monster.attack = 1 + random.randint(1, 5)
        monster.coin = 1
        monster.health = 25 + random.randint(1, 5)
        monster.exp = 1
        monster.author = "Aquankh#0309"
    ...
    if monster.name == "Skeleton Mage":
        ...
        monster.coin = 3
        monster.health = 22 + random.randint(1, 5)
        monster.exp = 3
        monster.author = "Aquankh#0309"
    ...
    if monster.name == "Red Crab":
        ...
        monster.DEFbash = 1
        monster.DEFpierce = 1
        monster.attack = 3 + random.randint(5, 10)
        monster.coin = 4
    ...
    if monster.name == "Pearl Clam":
        ...
        monster.DEFpierce = 5
        monster.attack = 1 + random.randint(1, 5)
        monster.coin = 15 + random.randint(1,10)
